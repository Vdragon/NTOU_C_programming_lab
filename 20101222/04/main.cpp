...
int main(void)
	...
	//for loop for each line
		for(yValue = 0, lineChar = inputNum; yValue < inputNum; yValue++, lineChar++)
			{
				//for loop for each char
					for(xValue = 0; xValue < lineChar; xValue++)
						{
							if(xValue + yValue == inputNum - 1 || xValue - yValue == inputNum - 1)
								{
									printf("＊");
								}
							else
		...
		for(yValue = 1, lineChar = 2 * inputNum - 1; yValue < inputNum; yValue++, lineChar--)
			{
				//for loop for each char
					for(xValue = 0; xValue < lineChar; xValue++)
						{
							if(xValue - yValue == 0 || yValue + xValue == 2 * inputNum - 2)
								{
									printf("＊");
								}
							else
